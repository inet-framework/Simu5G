...
class LteMacBase : public cSimpleModule
{
  ...
  public:
    ...
    virtual void ensureIncomingConnection(const FlowDescriptor& desc);
  ...
  protected:
    ...
    virtual void ensureIncomingConnectionInRemoteMac(MacNodeId destId, const FlowDescriptor& desc);
