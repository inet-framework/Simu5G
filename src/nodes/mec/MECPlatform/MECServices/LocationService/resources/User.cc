...
User::User(const inet::Ipv4Address& address, const MacCellId accessPointId, const std::string& resourceUrl, int zoneId) : address_(address), accessPointId_(accessPointId), resourceUrl_(resourceUrl) {}
