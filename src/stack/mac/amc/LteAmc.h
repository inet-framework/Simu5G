...
class LteAmc
{
  ...
  protected:
    ...
    double mcsScaleDl_ = 0.0;
    double mcsScaleUl_ = 0.0;
    double mcsScaleD2D_ = 0.0;
    int numAntennas_ = 0;
    ...
    unsigned int fbhbCapacityDl_ = 0;
    unsigned int fbhbCapacityUl_ = 0;
    unsigned int fbhbCapacityD2D_ = 0;
    omnetpp::simtime_t lb_;
    omnetpp::simtime_t ub_;
    double pmiComputationWeight_ = 0.0;
    double cqiComputationWeight_ = 0.0;
