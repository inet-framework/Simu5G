...
LtePhyUe::LtePhyUe() :
    ...
    masterId_(0),
    currentMasterRssi_(0.0),
    candidateMasterId_(0),
    candidateMasterRssi_(0.0),
    hysteresisTh_(0.0),
    hysteresisFactor_(0.0),
    handoverDelta_(0.0),
    handoverLatency_(0.0),
    handoverDetachment_(0.0),
    handoverAttachment_(0.0),
    minRssi_(0.0),
    enableHandover_(false),
    das_(nullptr),
    dasRssiThreshold_(0.0),
    useBattery_(false),
    txAmount_(0.0),
    rxAmount_(0.0),
    lastFeedback_(0),
